...
if (count($errors) === 0){
	...
	$url = "https://tb-210271.tech-base.net/mission6/registration_form.php"."?urltoken=".$urltoken;
...
// PHPMailerのインスタンス生成
    ...
    $mail->addAddress($tomail, '受信者さん'); //受信者（送信先）を追加する
...
//    $mail->addBcc('xxxxxxxxxx@xxxxxxxxxx'); // BCCで追加
    ...
    $body = <<< EOM
出欠太郎です。仮登録ありがとうございます。24時間以内に下記のURLからご登録ください。
{$url}
EOM;
